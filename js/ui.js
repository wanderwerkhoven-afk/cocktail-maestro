...
import { initSettings, applyThemeUI, openSettingsModal, closeSettingsModal, toggleLanguageList, closeLanguageList, toggleUnitList, closeUnitList, changeUnit, toggleThemeList, closeThemeList, changeTheme, openTermsModal, closeTermsModal, openPrivacyModal, closePrivacyModal, toggleAccountDetails, handleUpdateName, handlePasswordChange } from './pages/settings.js';
import { initNewsCarousel, openArticle, closeArticleModal } from './modules/news.js';
